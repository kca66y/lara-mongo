...
class FixMongoDBPassportCapability extends Command
{
    /**
     ...
     * @var string
     */
    protected string $mongo_model = 'Jenssegers\Mongodb\Eloquent\Model';
     ...
     * @var string
     */
    protected string $laravel_model = 'Illuminate\Database\Eloquent\Model';
     ...
     * @var string
     */
    protected string $passport_path = 'vendor/laravel/passport/src/';
